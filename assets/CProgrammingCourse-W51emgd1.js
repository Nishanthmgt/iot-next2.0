...
}`,iotRelevance:"Essential for complex IoT devices that must handle WiFi, sensors, and UI simultaneously without hanging.",keyPoints:["Task Scheduling","Priorities","Context Switching","Semaphores/Mutices"]},{name:"Low Power Management",desc:"Maximizing Battery Life",explanation:"IoT devices are often battery-powered. C allows you to put the CPU and peripherals into sleep states, waking them only when needed via timers or external triggers.",code:`// ESP32 Deep Sleep Example
...
DMA_Start(&config);
// CPU continues working while data transfers in background...`,iotRelevance:"High-speed data logging, audio processing, and fast display updates.",keyPoints:["Memory-to-Peripheral","Peripheral-to-Memory","Bus Mastering","Zero-CPU Overhead"]},{name:"Watchdog Timers (WDT)",desc:"System Self-Healing",explanation:"A WDT is a hardware timer that resets the system if the software hangs (fails to 'kick the dog'). It prevents remote IoT devices from becoming 'bricks' on site.",code:`#include <esp_task_wdt.h>
