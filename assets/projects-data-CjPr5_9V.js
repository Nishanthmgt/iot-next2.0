...
5. Test by waving in front of the PIR sensor.`,output:"A localized audible alarm followed by a push notification on your phone with a capture of the detected individual.",extensions:["Add facial recognition to whitelist family members","Integrate with Home Assistant via MQTT","Add solar charging for off-grid deployment"],useCase:"Ideal for remote warehouse monitoring, home doorstep security, and wildlife activity tracking.",advantages:["Low power consumption","Privacy-focused (Edge AI)","Zero monthly subscription fees"],disadvantages:["Sensitive to lighting conditions","Requires stable WiFi for cloud logs"],parts:[{name:"ESP32-CAM Module",buyLink:"https://robu.in/product/esp32-cam-development-board-with-ov2640-camera-module/"},{name:"HC-SR501 PIR Sensor",buyLink:"https://robu.in/product/hc-sr501-pir-motion-sensor-collector-module-for-arduino-and-raspberry-pi/"},{name:"Active Buzzer",buyLink:"https://robu.in/product/active-piezo-buzzer-5v/"}]}],o=[{title:"Voltage, Current & Resistance",content:"The holy trinity of electronics (Ohm's Law). Voltage is the pressure pushing electrons, Current is the flow of electrons, and Resistance is the opposition to that flow.",deepDive:"High current needs thick wires. High voltage needs insulation.",mistakes:"Shorting Power to Ground (Infinite Current = Fire).",tip:"Always check polarity before powering up."},{title:"Microcontrollers (The Brain)",content:"A small computer on a single chip. It reads inputs (sensors), processes data based on your code, and controls outputs (lights, motors). Common examples: Arduino Uno, ESP32, STM32.",deepDive:"They run firmware (C/C++), not a full OS like Windows.",mistakes:"Drawing too much current from a GPIO pin (>20mA).",tip:"Use transistors/MOSFETs to drive high-power loads."}];export{o as b,n as p};
