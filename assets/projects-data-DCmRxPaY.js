const t=e=>e.replace(/^\s{12}/gm,"").trim(),a=[{id:1,title:"LED Blink",level:"Beginner",estimatedTime:"15 mins",description:"The classic 'Hello World' of electronics. Learn how to control physical hardware using code by blinking an LED.",tech:["Arduino","LED"],category:"Basics",concept:"Digital Output Control",learning:["Setting up Arduino IDE","Digital pin configuration (OUTPUT mode)","Understanding digitalWrite()","Creating time delays with delay()","Basic C++ structure (setup & loop)"],workingPrinciple:"The microcontroller sends a HIGH (5V) or LOW (0V) signal to a specific GPIO pin. When HIGH, current flows through the LED, lighting it up. When LOW, current stops, turning it off.",circuit:"Connect the LED Anode to the microcontroller pin. For Arduino Uno use Pin 13. For ESP32 use GPIO 2. The Cathode must connect to GND via a 220-ohm resistor.",pins:[{from:"LED Positive (Anode)",to:"Arduino Pin 13 / ESP32 GPIO 2"},{from:"LED Negative (Cathode)",to:"Microcontroller GND"},{from:"Resistor (220Ω)",to:"Between LED & GND"}],code:t(`
            // Blink an LED
