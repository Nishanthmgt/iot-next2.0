...
int smooth = sum >> 6; // Divide by 64`,iotExample:"Battery level monitoring, audio sampling, analog joysticks."}]},{level:7,title:"Practical IoT Programs",color:"#2563eb",description:"Real working code for common IoT applications",programs:[{name:"LED Blink (Register Level)",code:`// Bare metal LED blink - Arduino Uno
