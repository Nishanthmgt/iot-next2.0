export const powerBatteryContent = {
    id: 'power-guide',
    title: 'Power & Battery Guide',
    subtitle: 'Powering your projects for days, months, or years',
    sections: [
        {
            id: 'power-basics',
...
**For breadboard**: Use thick jumper wires for power
        ...
        {
            id: 'battery-types',
            title: '🔋 Battery Types and Selection',
            content: `
...
\`\`\`
        ...
        },
        {
            ...
            title: '⚙️ Power Optimization Techniques',
            content: `
## Sleep Modes
...
\`\`\`
        ...
        {
            id: 'power-examples',
            title: '📋 Real-World Power Examples',
            content: `
