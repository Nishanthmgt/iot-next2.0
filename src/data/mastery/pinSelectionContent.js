export const pinSelectionContent = {
    id: 'pin-selection',
    title: 'Pin Selection Guide',
    subtitle: 'Which pins to use and which to avoid for stability',
    sections: [
        {
            id: 'arduino-pins',
            title: '🔵 Arduino Uno/Nano Pin Guide',
            content: `
## Digital Pins (D0-D13)
...
\`\`\`
        ...
        {
            id: 'pin-best-practices',
            title: '✅ Pin Selection Best Practices',
            content: `
## General Rules
