export const codeExplanationContent = {
    id: 'code-hub',
    title: 'Code Explanation Hub',
    subtitle: 'Breaking down complex firmware patterns into plain English',
    sections: [
        {
            id: 'state-machines',
...
\`\`\`
        ...
        {
            id: 'non-blocking-code',
            title: '⏱️ Non-Blocking Code Patterns',
            content: `
