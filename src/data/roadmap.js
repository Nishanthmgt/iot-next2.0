export const roadmapSteps = [
  {
    ...
    color: "#60a5fa",
    explanation: "Master C programming - the foundation language for embedded systems and IoT development.",
    steps: [
      {
        name: "C Fundamentals",
        desc: "Variables, operators, control flow, functions.",
        fullExplanation: "Learn C basics: data types (int, float, char), operators (arithmetic, logical, bitwise), control structures (if-else, loops), and functions. Essential foundation for embedded programming.",
        action: {
          label: "Start Course",
          view: "c-course"
        }
      },
      {
        ...
        desc: "Direct memory access and manipulation.",
        fullExplanation: "Master pointers, pointer arithmetic, dynamic memory allocation (malloc/free), structures, and unions. Critical for efficient IoT programming and hardware interfacing."
      },
      {
        name: "Embedded C Concepts",
        desc: "Register programming and bit manipulation.",
        fullExplanation: "Learn register-level programming, bit manipulation for GPIO control, volatile keyword for hardware registers, and interrupt service routines (ISR) implementation."
      },
      {
        name: "IoT-Specific C",
        desc: "Sensor handling and communication protocols.",
        fullExplanation: "Apply C to IoT: sensor data processing, UART/I2C/SPI implementation, state machines for event-driven code, and low-power optimization techniques."
      }
    ]
  },
  {
